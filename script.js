...
searchBox.addEventListener("submit",async e=>{
    ...
    if(locationInput.value.trim()===""){
         ...
         try{
              ...
              const imgSrc = `photos/${is_day ? weatherCondition.icons.day : weatherCondition.icons.night}`
              ...
              for(let i=0;i<7;i++){
                   ...
                   elem.className = "card"
                   elem.innerHTML = `<img src="photos/${weatherCond.icons.day}" alt="weather-icon" width="100" height="100"/>
                   <div class="temps">
